...
export class PaymentDto {
    ...
    @ApiProperty({ example: '2023-01-01T00:00:00.000Z', description: 'Current period start date' })
    currentPeriodStart: Date;

    @ApiProperty({ example: '2023-02-01T00:00:00.000Z', description: 'Current period end date' })
