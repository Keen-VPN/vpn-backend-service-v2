...
process.env.FIREBASE_PRIVATE_KEY_ID = process.env.FIREBASE_PRIVATE_KEY_ID || 'test-private-key-id';
...
process.env.FIREBASE_CLIENT_ID = process.env.FIREBASE_CLIENT_ID || 'test-client-id';
