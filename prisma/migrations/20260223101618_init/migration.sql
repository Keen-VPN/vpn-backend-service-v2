...
CREATE TABLE "session_aggregates" (
    "id" TEXT NOT NULL,
    "aggregation_date" TIMESTAMPTZ(6) NOT NULL,
    "platform" TEXT NOT NULL,
...
CREATE TABLE "node_clients" (
    ...
    CONSTRAINT "node_clients_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "node_clients_node_id_idx" ON "node_clients"("node_id");

-- CreateIndex
CREATE INDEX "node_clients_user_id_idx" ON "node_clients"("user_id");
...
-- AddForeignKey
ALTER TABLE "node_clients" ADD CONSTRAINT "node_clients_node_id_fkey" FOREIGN KEY ("node_id") REFERENCES "nodes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "node_clients" ADD CONSTRAINT "node_clients_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
